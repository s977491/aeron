...
public class SampleConfiguration
{
    ...
    public static final String DST_CONTROL_REQUEST_CHANNEL = "aeron:udp?endpoint=42.3.106.222:8095";
    public static final String DST_CONTROL_RESPONSE_CHANNEL = "aeron:udp?endpoint=42.3.106.222:8096";
    public static final String SRC_REPLICATION_CHANNEL = "aeron:udp?endpoint=112.120.203.143:8040";
    public static final String DST_REPLICATION_CHANNEL = "aeron:udp?endpoint=42.3.106.222:8041";
