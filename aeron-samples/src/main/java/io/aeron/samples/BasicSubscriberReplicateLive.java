 ...
 */
public class BasicSubscriberReplicateLive {
    ...
    public static void main(final String[] args) {
        ...
        final Aeron.Context ctx = new Aeron.Context()
                ...
                .unavailableImageHandler(BasicSubscriberReplicateLive::unavail);

        if (EMBEDDED_MEDIA_DRIVER) {
            ctx.aeronDirectoryName(driver.aeronDirectoryName());
        }

        final FragmentHandler fragmentHandler = BasicSubscriberReplicateLive::handler;
